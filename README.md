...
Another example of a full experiment is runnable via complex.sh over the ION network for 7 different loops with 1, 2, 3, or 4 nodes before loops. 

To run the bash script, run ``` ./complex.sh  ``` in the rerouting_simulator directory
